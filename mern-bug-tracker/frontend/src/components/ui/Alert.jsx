 ...
 * @returns {JSX.Element|null} Alert component or null if no message
 */
const Alert = ({ type = 'info', message, dismissible = false, onDismiss }) => {
  ...
  return (
    <div
      ...
      } border p-4 rounded-md flex items-start`}
      role="alert"
      data-testid="alert"
    >
      ...
      {dismissible && onDismiss && (
        <button
          type="button"
          className="flex-shrink-0 ml-3 -mt-1 -mr-1 p-1 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500"
          onClick={onDismiss}
          aria-label="Dismiss"
        >
